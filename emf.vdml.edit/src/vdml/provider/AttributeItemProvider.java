...
/**
 * This is the item provider adapter for a {@link vdml.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider extends VdmlElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_tag_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_tag_feature", "_UI_Attribute_type"),
				 VdmlPackage.Literals.ATTRIBUTE__TAG,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VdmlPackage.Literals.ATTRIBUTE__VALUE,
				 true,
				 false,
				 true,
				 null,
