...
/**
 * This is the item provider adapter for a {@link vdml.Participant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParticipantItemProvider extends MeasurableElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Participant_assignment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Participant_assignment_feature", "_UI_Participant_type"),
				 VdmlPackage.Literals.PARTICIPANT__ASSIGNMENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VdmlPackage.Literals.PARTICIPANT__PARTICIPANT_CALENDAR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VdmlPackage.Literals.PARTICIPANT__PARTICIPANT_CALENDAR,
