...
/**
 * This is the item provider adapter for a {@link smm.Argument} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArgumentItemProvider extends SmmElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmmPackage.Literals.ARGUMENT__TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmmPackage.Literals.ARGUMENT__VALUE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		Object labelValue = ((Argument)object).getShortDescription();
