 ...
 * <ul>
 *   <li>{@link smm.impl.ObservedMeasureImpl#getMeasure <em>Measure</em>}</li>
 *   <li>{@link smm.impl.ObservedMeasureImpl#getMeasurements <em>Measurements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ObservedMeasureImpl extends SmmRelationshipImpl implements ObservedMeasure {
	/**
	 ...
	 * @generated
	 */
	public EObject basicGetMeasure() {
		return measure;
	}
	 ...
	 * @generated
	 */
	public void setMeasure(EObject newMeasure) {
		EObject oldMeasure = measure;
		measure = newMeasure;
		if (eNotificationRequired())
