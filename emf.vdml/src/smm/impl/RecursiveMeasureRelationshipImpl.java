 ...
 * <ul>
 *   <li>{@link smm.impl.RecursiveMeasureRelationshipImpl#getFrom <em>From</em>}</li>
 *   <li>{@link smm.impl.RecursiveMeasureRelationshipImpl#getTo <em>To</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RecursiveMeasureRelationshipImpl extends MeasureRelationshipImpl implements RecursiveMeasureRelationship {
	...
	public void setFrom(EObject newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmmPackage.RECURSIVE_MEASURE_RELATIONSHIP__FROM, oldFrom, from));
	}
	...
	public void setTo(EObject newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmmPackage.RECURSIVE_MEASURE_RELATIONSHIP__TO, oldTo, to));
	}
