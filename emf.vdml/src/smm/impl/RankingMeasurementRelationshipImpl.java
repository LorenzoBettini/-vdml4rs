 ...
 * <ul>
 *   <li>{@link smm.impl.RankingMeasurementRelationshipImpl#getFrom <em>From</em>}</li>
 *   <li>{@link smm.impl.RankingMeasurementRelationshipImpl#getTo <em>To</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RankingMeasurementRelationshipImpl extends MeasurementRelationshipImpl implements RankingMeasurementRelationship {
	...
	public void setFrom(EObject newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmmPackage.RANKING_MEASUREMENT_RELATIONSHIP__FROM, oldFrom, from));
	}
