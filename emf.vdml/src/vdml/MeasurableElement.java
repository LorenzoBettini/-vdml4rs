 ...
 * </p>
 * <ul>
 *   <li>{@link vdml.MeasurableElement#getMeasuredCharacteristic <em>Measured Characteristic</em>}</li>
 * </ul>
 *
 * @see vdml.VdmlPackage#getMeasurableElement()
 * @model abstract="true"
 * @generated
 */
public interface MeasurableElement extends VdmlElement {
	 ...
	 * @see vdml.VdmlPackage#getMeasurableElement_MeasuredCharacteristic()
