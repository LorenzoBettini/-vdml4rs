 ...
 * </p>
 * <ul>
 *   <li>{@link vdml.impl.CapabilityOfferImpl#getCapability <em>Capability</em>}</li>
 *   <li>{@link vdml.impl.CapabilityOfferImpl#getCapabilityResource <em>Capability Resource</em>}</li>
 *   <li>{@link vdml.impl.CapabilityOfferImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link vdml.impl.CapabilityOfferImpl#getReleaseControl <em>Release Control</em>}</li>
 *   <li>{@link vdml.impl.CapabilityOfferImpl#getApplyingActivity <em>Applying Activity</em>}</li>
 *   <li>{@link vdml.impl.CapabilityOfferImpl#getHeatIndex <em>Heat Index</em>}</li>
 *   <li>{@link vdml.impl.CapabilityOfferImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link vdml.impl.CapabilityOfferImpl#getCapabilityProvider <em>Capability Provider</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public vdml.String getLocation() {
		if (location != null && location.eIsProxy()) {
			...
			if (location != oldLocation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VdmlPackage.CAPABILITY_OFFER__LOCATION, oldLocation, location));
			}
		}
		return location;
	}
