 ...
 * </p>
 * <ul>
 *   <li>{@link vdml.impl.CollaborationImpl#getContainedPort <em>Contained Port</em>}</li>
 *   <li>{@link vdml.impl.CollaborationImpl#getCollaborationRole <em>Collaboration Role</em>}</li>
 *   <li>{@link vdml.impl.CollaborationImpl#getGoal <em>Goal</em>}</li>
 *   <li>{@link vdml.impl.CollaborationImpl#getActivity <em>Activity</em>}</li>
 *   <li>{@link vdml.impl.CollaborationImpl#getFlow <em>Flow</em>}</li>
 *   <li>{@link vdml.impl.CollaborationImpl#getBusinessItem <em>Business Item</em>}</li>
 *   <li>{@link vdml.impl.CollaborationImpl#getInternalPortDelegation <em>Internal Port Delegation</em>}</li>
 *   <li>{@link vdml.impl.CollaborationImpl#getDelegationContext <em>Delegation Context</em>}</li>
 *   <li>{@link vdml.impl.CollaborationImpl#getScenario <em>Scenario</em>}</li>
 *   <li>{@link vdml.impl.CollaborationImpl#getOwnedAssignment <em>Owned Assignment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollaborationImpl extends ParticipantImpl implements Collaboration {
	...
	public EList<Goal> getGoal() {
		if (goal == null) {
			goal = new EObjectContainmentEList<Goal>(Goal.class, this, VdmlPackage.COLLABORATION__GOAL);
		}
		return goal;
	}
