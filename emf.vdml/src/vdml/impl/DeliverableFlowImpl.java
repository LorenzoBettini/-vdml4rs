 ...
 * </p>
 * <ul>
 *   <li>{@link vdml.impl.DeliverableFlowImpl#getRecipient <em>Recipient</em>}</li>
 *   <li>{@link vdml.impl.DeliverableFlowImpl#isIsTangible <em>Is Tangible</em>}</li>
 *   <li>{@link vdml.impl.DeliverableFlowImpl#getDeliverable <em>Deliverable</em>}</li>
 *   <li>{@link vdml.impl.DeliverableFlowImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link vdml.impl.DeliverableFlowImpl#getChannel <em>Channel</em>}</li>
 *   <li>{@link vdml.impl.DeliverableFlowImpl#getProvider <em>Provider</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeliverableFlowImpl extends MeasurableElementImpl implements DeliverableFlow {
	 ...
	 * @generated
	 */
	public vdml.String getChannel() {
		if (channel != null && channel.eIsProxy()) {
			InternalEObject oldChannel = (InternalEObject)channel;
			channel = (vdml.String)eResolveProxy(oldChannel);
			if (channel != oldChannel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VdmlPackage.DELIVERABLE_FLOW__CHANNEL, oldChannel, channel));
			}
		}
		return channel;
	}
	 ...
	 * @generated
	 */
	public vdml.String basicGetChannel() {
		return channel;
	}
	 ...
	 * @generated
	 */
	public void setChannel(vdml.String newChannel) {
		vdml.String oldChannel = channel;
		channel = newChannel;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case VdmlPackage.DELIVERABLE_FLOW__DURATION:
				...
				return;
			case VdmlPackage.DELIVERABLE_FLOW__CHANNEL:
				setChannel((vdml.String)newValue);
				return;
			case VdmlPackage.DELIVERABLE_FLOW__PROVIDER:
