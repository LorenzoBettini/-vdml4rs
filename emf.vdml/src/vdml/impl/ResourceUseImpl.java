 ...
 * </p>
 * <ul>
 *   <li>{@link vdml.impl.ResourceUseImpl#getDeliverable <em>Deliverable</em>}</li>
 *   <li>{@link vdml.impl.ResourceUseImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link vdml.impl.ResourceUseImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link vdml.impl.ResourceUseImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link vdml.impl.ResourceUseImpl#getPlanningPercentage <em>Planning Percentage</em>}</li>
 *   <li>{@link vdml.impl.ResourceUseImpl#isInputDriven <em>Input Driven</em>}</li>
 *   <li>{@link vdml.impl.ResourceUseImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link vdml.impl.ResourceUseImpl#isIsExclusive <em>Is Exclusive</em>}</li>
 *   <li>{@link vdml.impl.ResourceUseImpl#isResourceIsConsumed <em>Resource Is Consumed</em>}</li>
 * </ul>
 *
 * @generated
 */
