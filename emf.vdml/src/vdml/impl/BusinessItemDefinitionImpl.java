 ...
 * </p>
 * <ul>
 *   <li>{@link vdml.impl.BusinessItemDefinitionImpl#getPracticeDefinition <em>Practice Definition</em>}</li>
 *   <li>{@link vdml.impl.BusinessItemDefinitionImpl#getSupportedCapability <em>Supported Capability</em>}</li>
 *   <li>{@link vdml.impl.BusinessItemDefinitionImpl#isIsFungible <em>Is Fungible</em>}</li>
 *   <li>{@link vdml.impl.BusinessItemDefinitionImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link vdml.impl.BusinessItemDefinitionImpl#getCharacteristicDefinition <em>Characteristic Definition</em>}</li>
 *   <li>{@link vdml.impl.BusinessItemDefinitionImpl#isIsShareable <em>Is Shareable</em>}</li>
 *   <li>{@link vdml.impl.BusinessItemDefinitionImpl#getCapabilityDependency <em>Capability Dependency</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BusinessItemDefinitionImpl extends VdmlElementImpl implements BusinessItemDefinition {
	/**
