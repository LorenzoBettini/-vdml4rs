 ...
 * </p>
 * <ul>
 *   <li>{@link vdml.impl.StoreImpl#getStoreOwner <em>Store Owner</em>}</li>
 *   <li>{@link vdml.impl.StoreImpl#getStoreContext <em>Store Context</em>}</li>
 *   <li>{@link vdml.impl.StoreImpl#getSupportedCapability <em>Supported Capability</em>}</li>
 *   <li>{@link vdml.impl.StoreImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link vdml.impl.StoreImpl#getInventoryLevel <em>Inventory Level</em>}</li>
 *   <li>{@link vdml.impl.StoreImpl#getResource <em>Resource</em>}</li>
 * </ul>
 *
 * @generated
 */
