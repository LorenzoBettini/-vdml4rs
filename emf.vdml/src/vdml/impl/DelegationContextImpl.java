 ...
 * </p>
 * <ul>
 *   <li>{@link vdml.impl.DelegationContextImpl#getParentContext <em>Parent Context</em>}</li>
 *   <li>{@link vdml.impl.DelegationContextImpl#getContextBasedPortDelegation <em>Context Based Port Delegation</em>}</li>
 *   <li>{@link vdml.impl.DelegationContextImpl#getContextBasedAssignment <em>Context Based Assignment</em>}</li>
 *   <li>{@link vdml.impl.DelegationContextImpl#getDelegatedActivity <em>Delegated Activity</em>}</li>
 *   <li>{@link vdml.impl.DelegationContextImpl#getContextCollaboration <em>Context Collaboration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DelegationContextImpl extends AnalysisContextImpl implements DelegationContext {
	...
	public EList<Assignment> getContextBasedAssignment() {
		if (contextBasedAssignment == null) {
			contextBasedAssignment = new EObjectContainmentEList<Assignment>(Assignment.class, this, VdmlPackage.DELEGATION_CONTEXT__CONTEXT_BASED_ASSIGNMENT);
		}
